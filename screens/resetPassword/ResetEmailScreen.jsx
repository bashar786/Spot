...
const EmailScreen = () => {
  ...
  const email = 'mubsharalee@gmail.com';
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        navigation.navigate("ResetOTPEmail", { email });
      } else {
       ...
       <Header title="Enter Email" />
        ...
        >
          ...
          <View style={styles.inputArea}>
            <Text style={{ fontFamily: 'Poppins-Medium', color: '#1E3B2F', fontSize: 20 }}>Verify Registered Email</Text>
